...
-->
    ...
    <meta http-equiv='refresh' content='{next_time_refresh}'>
    <meta http-equiv="pragma" content="no-cache" />
    <!-- <script language="JavaScript" src="/dev2.3/js/script.js"></script> -->
    <link href="/dev2.3/tpl/style.css" rel="stylesheet" type="text/css" />
    <link href="/dev2.3/tpl/style_svg.css" rel="stylesheet" type="text/css" />
    <!-- <link rel="shortcut icon" href="/dev2.3/img/favicon.ico"/> -->
</head>
<body>
<div id="catalog">
{body}
